...
public class MainInstruments {
	...
	public static void main(String[] args) {
		/*En un grup de m�sica hi ha diferents tipus d�exercici1 musicals. Hi ha exercici1 de vent, de corda i de percussi�.

Tots els exercici1 tenen com a atributs el seu nom, i el seu preu. A m�s, tenen un m�tode anomenat tocar(). 
